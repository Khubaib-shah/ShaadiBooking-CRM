      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="rounded-xl p-4.5 space-y-4" style={{ background: 'var(--color-bg-sunken)', border: '1px solid var(--color-border)' }}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5 col-span-2">
              <label className="text-xs font-semibold" style={{ color: 'var(--color-text-secondary)' }}>Estimated Operational Expenses (Rs.)</label>
              <input type="number" {...register('expenses', { valueAsNumber: true })} placeholder="Cost of food, staff, venue rental etc." className="w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:border-[var(--color-accent)]"
                     style={{ background: 'var(--color-bg-elevated)', borderColor: 'var(--color-border)', color: 'var(--color-text-primary)', fontFamily: 'var(--font-mono)' }} />
            </div>
